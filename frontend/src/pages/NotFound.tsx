      ...
      <main className="relative z-10 w-full max-w-3xl px-6 py-24">
        <div className="mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              to="/"
              className="inline-flex items-center rounded-2xl border border-white/80 px-12 py-6 text-white text-xl font-medium hover:bg-white hover:text-orange-300 transition"
            >
              QUAY VỀ TRANG CHỦ
            </Link>
          </div>
