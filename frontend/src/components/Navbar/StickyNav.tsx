...
const dropdownItems = {
  "Sản Phẩm": [
    { label: "Điện thoại", path: "/san-pham/dien-thoai" },
    { label: "Máy tính bảng", path: "/san-pham/may-tinh-bang" },
    { label: "Phụ kiện", path: "/san-pham/phu-kien" },
  ],
  "Chiết Khấu": [
      ...
      <div className="pointer-events-auto">
        <div className="max-w-9xl mx-auto px-4 bg-gray-50">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 flex justify-center px-4" id="sticky-nav-menu">
                      ...
                      return (
                        ...
                        <div key={label} className="relative">
                          <button
                            ...
                            className={`flex items-center transition-colors duration-200 py-1 gap-1 text-gray-800 hover:text-white ${isActive ? "text-white" : ""}`}
                          >
                            {label}
                            {/* Mũi tên */}
                            <svg
                          ...
                          {/* Menu thả xuống */}
                          <div
                            className={`absolute left-1/2 transform -translate-x-1/2 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-xl z-30 ${isActive ? "block" : "hidden"}`}
                          >
